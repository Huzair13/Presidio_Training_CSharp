            ...
            <div class="card border-0 shadow-lg" >
                ...
                <div class="card-body quiz-card">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex flex-wrap flex-column flex-sm-row justify-content-between word-wrap-custom" style="background: #ECECEC;"><strong>Number of Questions:</strong> ${quiz.numOfQuestions}</li>
                        <li class="list-group-item d-flex flex-wrap flex-column flex-sm-row justify-content-between word-wrap-custom" style="background: #ECECEC;"><strong>Points:</strong> ${quiz.totalPoints}</li>
                        <li class="list-group-item d-flex flex-wrap flex-column flex-sm-row justify-content-between word-wrap-custom" style="background: #ECECEC;"><strong>Time Limit:</strong> ${quiz.timelimit} minutes</li>
                    </ul>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const createQuestion = document.getElementById('createQuestionHome');
    const createQuiz = document.getElementById('createQuizHome');

    createQuestion.addEventListener('click', function () {
        window.location.href = "/CreateQuestions/QuestionOption.html";
    })
