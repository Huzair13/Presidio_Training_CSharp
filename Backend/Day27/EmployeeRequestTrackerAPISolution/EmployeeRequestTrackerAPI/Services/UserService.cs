...
namespace EmployeeRequestTrackerAPI.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<EnableUserReturnDTO> EnableUserStatus(EnableUserDTO enableUserDTO)
        {
            User user = null;
            User result = null;
            EnableUserReturnDTO enabledUser = null;
            try { 
            
                user = await _userRepo.Get(enableUserDTO.EmployeeId);
                if(user != null)
                {
                    ...
                    enabledUser = MapUserToEnableUserReturnDTO(result, employee);
        ...
        private EnableUserReturnDTO MapUserToEnableUserReturnDTO(User result,Employee employee)
        {
            
            EnableUserReturnDTO enableUserReturnDTO = new EnableUserReturnDTO();
            enableUserReturnDTO.Name = employee.Name;
            enableUserReturnDTO.Id=result.EmployeeId;
            enableUserReturnDTO.Role = employee.Role;
            enableUserReturnDTO.status=result.Status;
            return enableUserReturnDTO;
        }
